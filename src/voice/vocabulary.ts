...
const ptBR: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-offers': ['catalogo de ofertas', 'catalogo', 'dezoito ofertas', 'ofertas do portfolio'],
...
const enUS: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-offers': ['offer catalog', 'catalog', 'eighteen offers', 'portfolio offers'],
