...
const ptBR: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-thesis': ['portfolio', 'pilares', 'pilares de valor', 'tese', 'tese e pilares', 'eixos', 'eixos de valor'],
    'portfolio-products': ['produtos', 'produtos foursys', 'fourblox', 'fourmakers', 'four makers', 'token4you', 'greentoken', 'weble', 'loome', 'stephubs', 'educ360'],
    'portfolio-offers': ['catalogo de ofertas', 'catalogo', 'vinte e uma ofertas', 'ofertas do portfolio', 'glossario', 'tokenomics', 'finops de tokens'],
    'portfolio-start': ['por onde comecar', 'contextos', 'caminhos recomendados', 'segmentos'],
    'portfolio-future': ['visao de futuro', 'futuro', 'tokenizacao', 'economia digital', 'greentoken'],
    'portfolio-assets': ['ativos transversais', 'ativos', 'nexus', 'fourmakers', 'fusion teams', 'capacity', 'hyperscalers', 'aceleracao com agentes', 'sustentacao', 'ams', 'outsourcing'],
    'portfolio-ecosystem': ['ecossistema do portfolio', 'ecossistema', 'mapa do portfolio', 'visao geral do portfolio', 'pontes do portfolio', 'cross sell'],
...
const enUS: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-thesis': ['portfolio', 'thesis', 'axes', 'value axes'],
    'portfolio-products': ['products', 'foursys products', 'fourblox', 'fourmakers', 'token4you', 'greentoken', 'weble', 'loome', 'stephubs', 'educ360'],
    'portfolio-offers': ['offer catalog', 'catalog', 'twenty-one offers', 'portfolio offers'],
    'portfolio-start': ['where to start', 'personas', 'shortlist', 'recommended sequence'],
    'portfolio-future': ['future vision', 'future', 'tokenization'],
    'portfolio-assets': ['cross-cutting assets', 'assets', 'nexus', 'fourmakers', 'fusion teams', 'capacity', 'hyperscalers', 'agent acceleration', 'sustainment', 'ams', 'outsourcing'],
    'portfolio-ecosystem': ['portfolio ecosystem', 'ecosystem', 'portfolio map', 'portfolio overview'],
