...
const ptBR: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-offers': ['catalogo de ofertas', 'catalogo', 'vinte e uma ofertas', 'ofertas do portfolio'],
    ...
    'portfolio-ecosystem': ['ecossistema do portfolio', 'ecossistema', 'mapa do portfolio', 'visao geral do portfolio'],
