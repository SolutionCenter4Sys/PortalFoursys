...
const ptBR: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-offers': ['catalogo de ofertas', 'catalogo', 'dezesseis ofertas', 'ofertas do portfolio'],
...
const enUS: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-offers': ['offer catalog', 'catalog', 'sixteen offers', 'portfolio offers'],
