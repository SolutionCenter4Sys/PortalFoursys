...
const ptBR: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-assets': ['ativos transversais', 'ativos', 'nexus', 'zeragon', 'sustentacao', 'ams', 'outsourcing'],
...
const enUS: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-assets': ['cross-cutting assets', 'assets', 'nexus', 'zeragon', 'sustainment', 'ams', 'outsourcing'],
