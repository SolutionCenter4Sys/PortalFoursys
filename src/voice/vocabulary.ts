...
const ptBR: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-offers': ['catalogo de ofertas', 'catalogo', 'dezenove ofertas', 'ofertas do portfolio'],
    ...
    'portfolio-assets': ['ativos transversais', 'ativos', 'nexus', 'fourblox', 'zeragon'],
...
const enUS: VocabularioVoz = {
  ...
  sinonimosRotulo: {
    ...
    'portfolio-offers': ['offer catalog', 'catalog', 'nineteen offers', 'portfolio offers'],
    'portfolio-start': ['where to start', 'personas', 'shortlist', 'recommended sequence'],
    'portfolio-future': ['future vision', 'future', 'tokenization'],
    'portfolio-assets': ['cross-cutting assets', 'assets', 'nexus', 'fourblox', 'zeragon'],
