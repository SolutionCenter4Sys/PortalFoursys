...
const CAIXAS_PT: ReadonlyArray<CaixaSecao> = [
  ...
  { id: 'portfolio-products-grid', secao: 'portfolio-products', rotulo: 'Produtos',
    rotulos: ['produtos', 'produtos foursys', 'fourblox', 'fourmakers', 'token4you', 'greentoken', 'weble', 'loome', 'stephubs', 'educ360'] },
  ...
  { id: 'portfolio-assets-grid', secao: 'portfolio-assets', rotulo: 'Ativos Transversais',
    rotulos: ['ativos transversais', 'ativos', 'nexus', 'fourmakers', 'fusion teams', 'capacity', 'hyperscalers', 'aceleracao com agentes', 'sustentacao'] },
...
const CAIXAS_EN: ReadonlyArray<CaixaSecao> = [
  ...
  { id: 'portfolio-products-grid', secao: 'portfolio-products', rotulo: 'Products',
    rotulos: ['products', 'foursys products', 'fourblox', 'fourmakers', 'token4you', 'greentoken', 'weble', 'loome', 'stephubs', 'educ360'] },
  ...
  { id: 'portfolio-assets-grid', secao: 'portfolio-assets', rotulo: 'Cross-cutting Assets',
    rotulos: ['cross-cutting assets', 'assets', 'nexus', 'fourmakers', 'fusion teams', 'capacity', 'hyperscalers', 'agent acceleration', 'sustainment'] },
