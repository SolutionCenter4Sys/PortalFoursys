...
const COMPARISON_PT: ComparisonRow[] = [
  ...
  },
  {
    ...
    bigFour: { value: '30-40%', detail: 'Maioria fica por muito tempo em piloto', score: 'low' },
...
const COMPARISON_EN: ComparisonRow[] = [
  ...
  },
  {
    ...
    bigFour: { value: '30-40%', detail: 'Most stay too long in pilot', score: 'low' },
...
const ADVANTAGES_PT: Advantage[] = [
  ...
  },
  {
    ...
    description: 'Enquanto 70% dos projetos de IA de grandes consultorias ficam por muito tempo em piloto, nosso método IA First converte 85% em produção em 6 semanas.',
    color: '#F59E0B',
    metric: '85%',
...
const ADVANTAGES_EN: Advantage[] = [
  ...
  },
  {
    ...
    description: 'While 70% of AI projects from large consultancies stay too long in pilot, our AI First method converts 85% to production in 6 weeks.',
    color: '#F59E0B',
    metric: '85%',
