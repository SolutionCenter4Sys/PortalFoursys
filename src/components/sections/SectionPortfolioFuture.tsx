...
export function SectionPortfolioFuture() {
  ...
  const { futureVision, assets } = useMemo(() => getPortfolio(lang), [lang])
  ...
  return (
    <SectionWrapper>
      <div className="px-4 md:px-8 py-6 md:py-10 max-w-7xl mx-auto">
          ...
          <div className="flex items-start md:items-end justify-between flex-wrap gap-3">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-cyan-400 mb-2 flex items-center gap-2">
                <Telescope size={13} /> {t('portfolio.badge')}
              </p>
        ...
        >
          <h3 className="text-[11px] font-bold uppercase tracking-[0.14em] text-cyan-400 mb-3">
            {t('portfolio.future.futureTitle')}
          </h3>
        ...
        {/* ── Ativos transversais ── */}
        <div>
          <h3 className="text-[11px] font-bold uppercase tracking-[0.14em] text-foursys-primary mb-3">
            {t('portfolio.future.assetsTitle')}
          </h3>
              ...
              return (
                ...
                >
                  <div className="w-9 h-9 rounded-xl bg-foursys-primary/10 border border-foursys-primary/25 flex items-center justify-center flex-shrink-0">
                    <Icon size={16} className="text-foursys-primary" />
                  </div>
                  <div>
