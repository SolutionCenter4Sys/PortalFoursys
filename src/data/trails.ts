...
export const trails: Trail[] = [
  {
    ...
    colorHex: '#FF6600',
    steps: [
      { sectionId: 'opening',            estimatedMinutes: 3 },
      { sectionId: 'identity',           estimatedMinutes: 5 },
      { sectionId: 'santander-insights', estimatedMinutes: 8 },
      { sectionId: 'quality-ia',         estimatedMinutes: 7 },
  ...
  },
  {
    ...
    steps: [
      ...
      { sectionId: 'santander-insights', estimatedMinutes: 10 },
      { sectionId: 'quality-ia',         estimatedMinutes: 10 },
      { sectionId: 'shi-case',           estimatedMinutes: 10 },
  ...
  },
  {
    ...
    steps: [
      ...
      { sectionId: 'capabilities',   estimatedMinutes: 6  },
    ]
  },
  {
    id: 'negocio',
