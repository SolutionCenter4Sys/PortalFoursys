...
const faqItemsPt: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Temos presença global com 8 localidades em 4 regiões do globo: Barueri (sede), São Paulo (Paulista e Inovabra Habitat), Curitiba, Rio de Janeiro, Belo Horizonte, Lisboa (Portugal) e Boca Raton (EUA). Atuamos em 4 regiões do globo com capacidade de delivery remoto e presencial.',
    sectionLink: 'global',
...
const faqItemsEn: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'We have a global presence with 8 office locations across 4 global regions: Barueri (headquarters), São Paulo (Paulista and Inovabra Habitat), Curitiba, Rio de Janeiro, Belo Horizonte, Lisbon (Portugal), and Boca Raton (USA). We operate across 4 global regions with both remote and on-site delivery capabilities.',
    sectionLink: 'global',
