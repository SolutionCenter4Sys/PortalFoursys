...
import { JarvisLaunchButton } from '../jarvis/JarvisLaunchButton'
...
export function TopBar({ jarvisOpen = false, onJarvisToggle }: TopBarProps) {
  const {
    state,
    navigate,
    openSearch,
  ...
  return (
    ...
    `} style={{ borderColor: 'var(--border-subtle)' }}>
      ...
      {/* Jarvis — substitui o mic Touchless */}
      <JarvisLaunchButton
        active={jarvisOpen}
        onClick={() => onJarvisToggle?.()}
        label={lang === 'en' ? 'Open Jarvis' : 'Abrir Jarvis'}
      />
